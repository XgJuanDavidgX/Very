...
export default function NavMenu(){
  ...
  return(
    <div className="bg-white pb-3 dark:bg-[#18171c]">
          ...
          <div className="flex">
            ...
            <div className="flex text-white items-center">
              <div className="flex relative bg-black w-10 h-6 rounded-full justify-around items-center mr-8 px-6 cursor-pointer dark:bg-yellow-400" onClick={cambiarTema}>
                <div className="absolute z-30 left-[2px] bg-white rounded-full w-5 h-5 transition-transform dark:translate-x-[1.5rem] dark:bg-black"></div>
